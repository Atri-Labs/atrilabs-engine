  ...
  const str = JSON.stringify(
    {
      ...
      dependencies: {
        "@atrilabs/atri-app-core": "^1.0.0-alpha.1",
        "@atrilabs/canvas-zone": "^1.0.0-alpha.1",
        "@atrilabs/commands": "^1.0.0-alpha.1",
        "@atrilabs/commands-builder": "^1.0.0-alpha.1",
        "@atrilabs/core": "^1.0.0-alpha.1",
        "@atrilabs/design-system": "^1.0.0-alpha.1",
        "@atrilabs/pwa-builder": "^1.0.0-alpha.1",
        "@atrilabs/pwa-builder-server": "^1.0.0-alpha.1",
        "@atrilabs/react-component-manifests": "^1.0.0-alpha.1",
        "@atrilabs/utils": "^1.0.0-alpha.1",
        "node-noop": "^1.0.0",
        react: "18.2.0",
        "react-dom": "18.2.0",
        xstate: "^4.35.2",
