  ...
  const str = JSON.stringify(
    {
      ...
      dependencies: {
        "@atrilabs/atri-app-core": "^1.0.0-alpha.3",
        "@atrilabs/canvas-zone": "^1.0.0-alpha.3",
        "@atrilabs/commands": "^1.0.0-alpha.3",
        "@atrilabs/commands-builder": "^1.0.0-alpha.3",
        "@atrilabs/core": "^1.0.0-alpha.3",
        "@atrilabs/design-system": "^1.0.0-alpha.3",
        "@atrilabs/pwa-builder": "^1.0.0-alpha.3",
        "@atrilabs/pwa-builder-server": "^1.0.0-alpha.3",
        "@atrilabs/react-component-manifests": "^1.0.0-alpha.3",
        "@atrilabs/utils": "^1.0.0-alpha.3",
        "node-noop": "^1.0.0",
        react: "18.2.0",
        "react-dom": "18.2.0",
        xstate: "^4.35.2",
