  ...
  const str = JSON.stringify(
    {
      ...
      dependencies: {
        "@atrilabs/atri-app-core": "^1.0.0-alpha.21",
        "@atrilabs/canvas-zone": "^1.0.0-alpha.21",
        "@atrilabs/commands": "^1.0.0-alpha.21",
        "@atrilabs/commands-builder": "^1.0.0-alpha.21",
        "@atrilabs/core": "^1.0.0-alpha.21",
        "@atrilabs/design-system": "^1.0.0-alpha.21",
        "@atrilabs/pwa-builder": "^1.0.0-alpha.21",
        "@atrilabs/pwa-builder-server": "^1.0.0-alpha.21",
        "@atrilabs/react-component-manifests": "^1.0.0-alpha.21",
        "@atrilabs/utils": "^1.0.0-alpha.21",
        "cross-env": "^7.0.3",
        "node-noop": "^1.0.0",
        react: "18.2.0",
        "react-dom": "18.2.0",
